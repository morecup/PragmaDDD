...
import org.morecup.pragmaddd.core.bridge.ConstructorBridgeConfig

@Aspect
class AggregateRootConstructorAspect {

    @Pointcut("execution(*.new(..)) && (@within(org.morecup.pragmaddd.core.annotation.AggregateRoot) || @within(org.morecup.pragmaddd.core.annotation.DomainEntity))")
